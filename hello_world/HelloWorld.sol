...
//any contract needs a contract object amd we need to specify the name of it:

contract HelloWorld
{
    string greeting;

    //the constructor is a function that runs once and when you deploy the app
    //it is great to set values
    constructor()
    {
        greeting = "Hello, World aa";
    ...
    function sayHello() public view returns (string memory)
    {
        //public: you can call the function from outside of this contract
            //if you declare it private or internal, you woldn't be able to do that
